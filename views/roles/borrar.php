...
if (isset($_SESSION["user"])) {
  ...
  for ($i = 0; $i < count($res); $i++) {
    if ($res[$i]['titulo'] == 'ROLES' && $res[$i]['Eliminar'] == 1) {
      $borrarModulo = 'OK';
    }
  }
  if ($borrarModulo == 'OK') {
    ...
    if (isset($_POST["form"]) and $_POST["form"] == "borrar-data") {
      $i = $_POST["idR"];
      $app = new Roles();
      $resp = $app->deleteRol($i);
    }
?>
    <!DOCTYPE html>
    <html lang="es">
              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Elimiar datos</li>
                  </ol>
                </div><!-- /.col -->
              </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                  <div class="modal-content">
                    <div class="modal-header bg-primary">
                      <h4 class="modal-title">¿Seguro que desea <strong>borrar</strong> este Rol?</h4>
                    </div>
                      ...
                      <form action="#" method="post" class="bordered">
                        <center>
                          ...
                          if (!$res) {
                            ...
                            for ($i = 0; $i < count($res); $i++) {
                          ?>
                              <input type="hidden" name="form" value="borrar-data">
