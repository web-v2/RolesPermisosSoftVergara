                  ...
                  "columns": [{
                    ...
                    },
                    {
                      ...
                      render: function(data, type, row) {
                        return "<a href='editar-rol/" + data['idRol'] + "' class='btn btn-sm btn-primary'><i class='fas fa-edit'></i> Editar</a>"
                      }
                    },
                    {
                      "data": null,
                      render: function(data, type, row) {
                        return "<a href='modulos/" + data['idRol'] + "' class='btn btn-sm btn-success'><i class='fas fa-key'></i> Módulos</a>"
                      }
                    },
                    {
                      "data": null,
                      render: function(data, type, row) {
                        return "<a href='eliminar-rol/" + data['idRol'] + "' class='btn btn-sm btn-danger'><i class='far fa-trash-alt'></i> Borrar</a>"
                      }
                    }
                  ],
                  bJQueryUI: true,
